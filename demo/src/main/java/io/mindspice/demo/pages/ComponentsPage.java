                ...
                .addRow(row -> row
                        .withChild(new Column().withWidth(6).withChild(
                                ContentModule.create()
                                        ...
                                        .withCustomContent(
                                                UnorderedList.create()
                                                        .addItem("Category A Products")
                                                        .addItem("Category B Products")
                                                        .addItem("Category C Products")
                                                        .addItem("Mixed Categories")
                                        )
                        ))
                        .withChild(new Column().withWidth(6).withChild(
                                ContentModule.create()
                                        ...
                                        .withCustomContent(
                                                OrderedList.create()
                                                        .addItem("Initialization (1-7 days)")
                                                        .addItem("Initial Stage (2-3 weeks)")
                                                        .addItem("Processing (3-16 weeks)")
                                                        .addItem("Quality Check (8-11 weeks)")
