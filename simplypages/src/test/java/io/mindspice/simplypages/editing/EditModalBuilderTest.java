...
public class EditModalBuilderTest {
    ...
    void testChildAddButton() {
        ...
        assertTrue(html.contains("hx-get=\"/add-child\""), "Should have hx-get attribute for add URL");

        // Also verify the section is rendered even if no children
        assertTrue(html.contains("Content Items"), "Should contain 'Content Items' header even with no children");
    }
}
