...
public class EditModalBuilder {
    ...
    private Div buildChildrenSection() {
        ...
        Div header = new Div().withClass("d-flex justify-content-between align-items-center mb-3");
        header.withChild(Header.H4("Content Items").withClass("m-0"));
